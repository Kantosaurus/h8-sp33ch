...
from elisha.models.logistic_regression_model import LogisticRegressionModel
from elisha.models.svm_model import SVMModel
from elisha.models.random_forest_model import RandomForestModel
from elisha.models.xgboost_model import XGBoostModel
from elisha.models.naive_bayes_model import NaiveBayesModel
from elisha.models.extra_trees_model import ExtraTreesModel
from elisha.models.lightgbm_model import LightGBMModel
from elisha.models.catboost_model import CatBoostModel
from elisha.models.meta_classifier import MetaClassifier
from elisha.models.elastic_net_model import ElasticNetModel
from elisha.models.linear_svc_model import LinearSVCModel
from elisha.models.knn_model import KNNModel
...
class HateSpeechEnsemble:
    ...
    def initialize_models(self):
        ...
        self.base_models = {
            'knn': KNNModel(random_state=self.random_state),
            'lin_svc': LinearSVCModel(random_state=self.random_state),
            'naive_bayes': NaiveBayesModel(random_state=self.random_state),
            'log_reg': LogisticRegressionModel(random_state=self.random_state),
    ...
    def load_data(self):
        ...
        X_train_tfidf = train_tfidf.iloc[:, 2:].values
        X_test_tfidf = test_tfidf.iloc[:, 1:].values
        y_train = train_data['label'].values
        
        print(f"Training set shape: {X_train_tfidf.shape}")
        print(f"Test set shape: {X_test_tfidf.shape}")
        
        return X_train_tfidf, X_test_tfidf, y_train, test_data['id'].values, train_data['post'].values, test_data['post'].values
